<template>
    <div class="title-home-component">
        <div class="row">
            <div class="col-md-6 offset-md-5">
                <div class="card">
                    <div class="card-photo"></div>
                    <div class="card-title">NICOLAS RODRIGUEZ <br>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <p>{{ contenido }}</p>
                <button class="cti home" @click="scrollToSection('section3')">
                    <div class="CTI home" :class="{'dark-style': darkMode }">
                    PROJECTS
                    </div>
                </button>  
            </div>
...
<script>
    ...
    data() {
      return {
        ...
        items_title: {
          miTitulo: 'PROJECTS',
          miContenido: 'Lorem ipsum dolor sit amet consectetur adipisicing elit.'
        }        
      };
    },   
    props: {
...
<style>
    ...
    .title-home-component h1{
        color: black;
        text-align: center;
    }
    .title-home-component p{
        color: #313131f8;
        text-align: center;
        font-size: 20px;        
    }   
    ...
    .cti:hover .CTI.dark-style {
        color: #ffffff;
    }
    .cti:hover .CTI.home.dark-style {
        color: #000;
    }
</style>